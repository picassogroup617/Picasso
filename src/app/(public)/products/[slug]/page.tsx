      ...
      <section className="container-page py-10 sm:py-14">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="flex min-w-0 flex-col">
            ...
            <h1 className="mt-2 inline-block max-w-full self-start break-words rounded-xl bg-brand-gray-200 px-4 py-2 font-display text-3xl font-bold tracking-wide text-brand-gray-900 sm:text-4xl">
              {product.name}
            </h1>
