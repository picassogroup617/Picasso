        ...
        <div className="container-page py-12 sm:py-16">
          ...
          <div className="mt-4 grid gap-8 sm:grid-cols-[1fr_auto] sm:items-end">
            <div>
              ...
              <h1 className="mt-2 font-display text-3xl font-bold tracking-wide sm:text-5xl">
                {category.name}
              </h1>
      ...
      <section className="container-page py-14">
        {products.length === 0 ? (
          <div className="rounded-xl border border-dashed border-brand-gray-200 bg-brand-white p-10 text-center">
            <h2 className="font-display text-xl font-bold tracking-wide text-brand-gray-900">
              No products to show
            </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between gap-3 p-5">
                    <h3 className="font-display text-base font-bold tracking-wide text-brand-gray-900">
                      {p.name}
                    </h3>
  ...
  return (
    <section className="container-page py-20">
      <div className="mx-auto max-w-lg rounded-xl border border-dashed border-brand-gray-200 bg-brand-white p-10 text-center">
        <h1 className="font-display text-2xl font-bold tracking-wide text-brand-gray-900">
          Category not found
        </h1>
        <p className="mt-2 text-sm text-brand-gray-500">
