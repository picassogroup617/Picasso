      ...
      <section className="relative overflow-hidden border-b border-brand-gray-200 bg-brand-gray-100">
        ...
        <div className="container-page relative z-10 py-8 sm:py-12">
          <div className="mx-auto max-w-4xl text-center">
            ...
            />
            <h1 className="mt-3 whitespace-nowrap font-display text-[0.9rem] font-bold leading-[1.1] tracking-wide text-brand-gray-900 sm:text-[1.25rem] md:text-[1.6rem] lg:text-[2rem]">
              {heroTitle}
            </h1>
        ...
        <div className="container-page">
          <div className="flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 font-display text-3xl font-bold tracking-wide sm:text-4xl">
              ...
              {categories.map((c) => (
                ...
                >
                  ...
                  <div className="p-4 text-center">
                    <h3 className="font-display text-base font-bold tracking-wide text-brand-gray-900 transition-colors group-hover:text-brand-yellow-600">
                      {c.name}
                    </h3>
                  </div>
                </Link>
